...
export const placeholderData: Array<Task> = [
    ...
    },
    {
        ...
        description: "Fusce eget lacus sed lectus imperdiet pulvinar sed vel magna. Etiam accumsan velit justo. Vestibulum volutpat mi sit amet dolor hendrerit ullamcorper. Vivamus rhoncus et ante et iaculis. Nam eget arcu dolor. Cras ultrices.",
        completed: false
    },
]